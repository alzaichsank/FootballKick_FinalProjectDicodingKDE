package alzaichsank.com.aplikasifootbalmatchschedule.view.search.team.adapter
...
class SearchTeamAdapter (private val onClickListener: (position: Int) -> Unit) : BaseAdapter<RecyclerView.ViewHolder, TeamsListItem>() {
