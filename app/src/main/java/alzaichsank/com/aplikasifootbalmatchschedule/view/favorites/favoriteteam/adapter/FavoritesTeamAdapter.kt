package alzaichsank.com.aplikasifootbalmatchschedule.view.favorites.favoriteteam.adapter
...
class FavoritesTeamAdapter (private val onClickListener: (position: Int) -> Unit) : BaseAdapter<RecyclerView.ViewHolder, TeamsListItem>() {
