...
import alzaichsank.com.aplikasifootbalmatchschedule.utils.DateTime.getBasicTime
import alzaichsank.com.aplikasifootbalmatchschedule.utils.DateTime.getLongDate
import alzaichsank.com.aplikasifootbalmatchschedule.utils.DateTime.toGMTFormat
...
class matchAdapter(private val menuItem : Int,private val onClickListener: (position: Int) -> Unit) : BaseAdapter<RecyclerView.ViewHolder, EventsItem>() {
    ...
    fun bindData(data: EventsItem, position: Int,menuData : Int) {
            ...
            1-> {
                ...
                if (data.strTime.equals("00:00:00+00:00")) {
                    ...
                    itemView.time.text = getBasicTime(toGMTFormat(data.dateEvent.toString(),data.strTime.toString()))
                }
